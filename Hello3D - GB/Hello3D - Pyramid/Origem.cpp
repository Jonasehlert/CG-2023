...
glm::vec3 cameraPos = glm::vec3(0.0, 3.0, 3.0);
...
//#endif
	...
	obj1.initialize("../../3D_models/Pokemon/Pikachu.obj", &shader, glm::vec3(-6.0, 0.0, 0.0));
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		if (rotateX)
		{
			if (selec == 1)
			{
				obj.initialize("../../3D_models/Pokemon/Pikachu.obj", &shader, glm::vec3(-3.0, 0.0, 0.0), glm::vec3(-1.0, -1.0, -1.0), angle, glm::vec3(1.0f, 0.0f, 0.0f));
				obj.update();
				obj.draw();
			}
			...
			if (selec == 2)
			{
				obj1.initialize("../../3D_models/Pokemon/Pikachu.obj", &shader, glm::vec3(0.0, 0.0, 0.0), glm::vec3(-1.0, -1.0, -1.0), angle, glm::vec3(1.0f, 0.0f, 0.0f));
				obj1.update();
				obj1.draw();
			}
		}
		...
		if (stopRotate)
		{
			...
			obj.initialize("../../3D_models/Pokemon/Pikachu.obj", &shader);
			obj1.initialize("../../3D_models/Pokemon/Pikachu.obj", &shader, glm::vec3(-3.0, 0.0, 0.0));
		...
		else if (rotateY)
		{
			if (selec == 1)
			{
				obj.initialize("../../3D_models/Pokemon/Pikachu.obj", &shader, glm::vec3(-3.0, 0.0, 0.0), glm::vec3(-1.0, -1.0, -1.0), angle, glm::vec3(0.0f, 1.0f, 0.0f));
				obj.update();
				obj.draw();
			}
			...
			if (selec == 2)
			{
				obj1.initialize("../../3D_models/Pokemon/Pikachu.obj", &shader, glm::vec3(0.0, 0.0, 0.0), glm::vec3(-1.0, -1.0, -1.0), angle, glm::vec3(0.0f, 1.0f, 0.0f));
				obj1.update();
				obj1.draw();
			}
		...
		else if (rotateZ)
		{
			...
			if (selec == 1)
			{
				obj.initialize("../../3D_models/Pokemon/Pikachu.obj", &shader, glm::vec3(-3.0, 0.0, 0.0), glm::vec3(-1.0, -1.0, -1.0), angle, glm::vec3(0.0f, 0.0f, 1.0f));
				obj.update();
				obj.draw();
			}
			...
			if (selec == 2)
			{
				obj1.initialize("../../3D_models/Pokemon/Pikachu.obj", &shader, glm::vec3(0.0, 0.0, 0.0), glm::vec3(-1.0, -1.0, -1.0), angle, glm::vec3(0.0f, 0.0f, 1.0f));
				obj1.update();
				obj1.draw();
			}
		...
		if (translateY)
		{
			if (selec == 1)
			{
				obj.initialize("../../3D_models/Pokemon/Pikachu.obj", &shader, glm::vec3(3.0, 3.0, 0.0));
				obj.update();
				obj.draw();
			}
		...
		if (translateZ)
		{
			if (selec == 1)
			{
				obj.initialize("../../3D_models/Pokemon/Pikachu.obj", &shader, glm::vec3(3.0, 3.0, 3.0));
				obj.update();
				obj.draw();
			}
		...
		if (scale)
		{
			if (selec == 1)
			{
				obj.initialize("../../3D_models/Pokemon/Pikachu.obj", &shader, glm::vec3(-3.0, 0.0, 0.0), glm::vec3(0.5, 0.5, 0.5));
				obj.update();
				obj.draw();
			...
			if (selec == 2)
			{
				obj1.initialize("../../3D_models/Pokemon/Pikachu.obj", &shader, glm::vec3(0.0, 0.0, 0.0), glm::vec3(0.5, 0.5, 0.5));
				obj1.update();
				obj1.draw();
		...
		if (scale == false)
		{
			if (selec == 1)
			{
				obj.initialize("../../3D_models/Pokemon/Pikachu.obj", &shader, glm::vec3(-3.0, 0.0, 0.0), glm::vec3(1.0, 1.0, 1.0));
			}

			if (selec == 2)
			{
				obj1.initialize("../../3D_models/Pokemon/Pikachu.obj", &shader, glm::vec3(0.0, 0.0, 0.0), glm::vec3(1.0, 1.0, 1.0));
